...
class CargaParticipantesScreen extends StatefulWidget {
  ...
  @override
  State<CargaParticipantesScreen> createState() => _CargaParticipantesScreenState();
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Mensaje de estado
            Obx(() => controller.mensaje.value.isNotEmpty
                ? Container(
            ...
            Expanded(
              child: Obx(() => controller.participantes.isEmpty
                  ? const Center(
                      child: Text(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: controller.participantesExisten.value
              ? const Text('Ya existen participantes cargados para este sorteo. ¿Desea visualizarlos?')
              : const Text('¿Está seguro que desea cargar los participantes desde el archivo Excel?'),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              ...
              child: Text(controller.participantesExisten.value ? 'Ver Participantes' : 'Cargar Excel'),
            ),
          ],
        );
      },
